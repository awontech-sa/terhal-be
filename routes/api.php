...
Route::post('/password-reset/verify-phone-otp', [PasswordResetController::class, 'verifyOtp']);  // 2
...
Route::get('/user/profile', [UserController::class, 'show'])->middleware('auth:sanctum'); // Show user profile
